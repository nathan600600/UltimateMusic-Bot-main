    ...
    constructPrimaryConfigurationSchema() {
        return {
            ...
            lavalink: {
                ...
                password: EnvironmentVariableProcessor.LAVALINK_PASSWORD || "ajieblogs", 
            ...
            bot: {
                ...
                ownerIds: ["934810515916603472"],      // 👈 ADD YOUR DISCORD ID HERE
                embedColor: 0x00AE86,               // 👈 Bot embed color (hex)
                supportServer: "https://discord.gg/W7ZPYwwFT5",    // 👈 Your support server link
                defaultStatus: " Coucou toi ^^!"         // 👈 Bot status message
            },
